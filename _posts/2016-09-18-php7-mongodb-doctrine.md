...
Com as ferramentas instaladas e o driver configurado, podemos criar a pasta para iniciar o projeto, no meu caso chamarei de `doctrine-odm-blog`, feito isso, é necessário criar o arquivo composer.json para instalar as dependências, incluindo o Doctrine ODM, o arquivo deverá ficar parecido o JSON a seguir.
