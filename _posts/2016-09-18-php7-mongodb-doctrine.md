...
comments: true
---
Faz um tempo que estou utilizando PHP com MongoDB e que vi que tinha uma versão do Doctrine que poderia me ajudar com isso, porém quando tinha visto (ano passado) e fui fazer uns testes tive alguns problemas por ainda estar na versão BETA, esses dias resolvi olhar novamente e vi já faz um tempo que a versão 1.0 foi lançada e que já está até na versão 1.1, então decidi fazer uns testes novamente e compartilhar aqui no blog.
